<footer class="bg-gray-300 w-full py-6 px-4 my-32 ">
            ...
            <form action="#" class="mt-2">
                <div class="flex items-center">
                    <input type="email"
                        ...
                        required>
                    <button class="bg-red-300 text-gray-200 px-5 py-2 rounded shadow " style="margin-left: -7.8rem;">Sign
                        Up</button>
                </div>
            </form>
        </div>
    ...
    <div class="flex items-center justify-between my-4">
        <p class="text-red-500">All rights reserved</p>
        <div class="flex items-center">
            <a href="#">
                <svg class="h-6 w-6 fill-current text-red-500 mr-6" viewBox="0 0 512 512">
                    <path
                        d="M455.27,32H56.73A24.74,24.74,0,0,0,32,56.73V455.27A24.74,24.74,0,0,0,56.73,480H256V304H202.45V240H256V189c0-57.86,40.13-89.36,91.82-89.36,24.73,0,51.33,1.86,57.51,2.68v60.43H364.15c-28.12,0-33.48,13.3-33.48,32.9V240h67l-8.75,64H330.67V480h124.6A24.74,24.74,0,0,0,480,455.27V56.73A24.74,24.74,0,0,0,455.27,32Z" />
                </svg>
            </a>
            <a href="#">
                <svg fill="none" class="h-6 w-6 text-red-500 mr-6" viewBox="0 0 24 24" stroke="currentColor">
